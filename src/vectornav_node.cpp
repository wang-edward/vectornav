...
namespace vectornav {
  ...
  VectornavNode::VectornavNode(const rclcpp::NodeOptions& options): Node{"vectornav_node", options} {
    ...
    this->timer = this->create_wall_timer(delay, publish);
  }
  ...
  static inline geometry_msgs::msg::Quaternion VectornavNode:: toMsg(const vn::math::vec4f & rhs) {
  ...
  static inline geometry_msgs::msg::Vector3 VectornavNode:: toMsg(const vn::math::vec3f & rhs) {
